...
TEST(model, construct_transaction)
{
	...
	ASSERT_STREQ("f93b1b635eaaeea21b26ebf1e10f62dc8874add6592737a1540d28ec9432eaa9", transaction.id().c_str());
	...
	ASSERT_STREQ("DAYS6o9sA51kMCSaSP216GZ8pomGkRsQiR", transaction.sender_id().c_str());
	ASSERT_STREQ("D7FyqZohN83vxQdqUjJWqD2CPQBxhut9WD", transaction.recipient_id().c_str());
	ASSERT_STREQ("039b5a3a71335bfa6c72b82498f814123e0678f7cd3d8e7221ec7124918736e01c", transaction.sender_publickey().c_str());
	ASSERT_STREQ("3045022100f632a89be97cb928cef6358b1a6c0e5b44381288ffe3f977768052c39f44c31102200cdfb289240ba03628d6b487d3869881de981322a8826bb5749704e6f6baa63b", transaction.signature().c_str());
