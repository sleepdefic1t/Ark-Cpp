...
TEST(api, test_transaction)
{
	...
	ASSERT_STREQ("4e68a917d06382ce335656eef5560a537fc806ecadf3972c5221b86babecc63e", transaction.id().c_str());
	...
	ASSERT_STREQ("DPJBH7wfE1msZMVDQLeJUPi31fJZodJCkU", transaction.sender_id().c_str());
...
// {
// 	ARK::API::Manager _arkManager(ARK::Constants::Networks::Model::Devnet);
// 	const auto delegate = _arkManager.transactions();
// }
